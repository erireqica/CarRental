...
function HomeDashboard() {
  ...
  if (!content) return <div className="p-10 text-center">Loading dashboard...</div>;
  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto py-10 px-4 md:px-8">
        <h1 className="text-3xl font-bold mb-10 text-center text-blue-700">Homepage Editor Dashboard</h1>
